            ...
            <div class="grid md:grid-cols-4 gap-12 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm">
                        <li><a href="{{ route('landing.program') }}" class="hover:text-primary-500 transition">TPA (Taman Pendidikan Al-Qur'an)</a></li>
                        <li><a href="{{ route('landing.program') }}" class="hover:text-primary-500 transition">TK Islam</a></li>
                        <li><a href="{{ route('landing.program') }}" class="hover:text-primary-500 transition">SDIT</a></li>
                        <li><a href="{{ route('landing.program') }}" class="hover:text-primary-500 transition">SMP IT Boarding</a></li>
                        <li><a href="{{ route('landing.program') }}" class="hover:text-primary-500 transition">SMA IT Boarding</a></li>
                    </ul>
                </div>
                <div>
                    <h4 class="text-white font-bold mb-6">Tautan</h4>
                    <ul class="space-y-3 text-sm">
                        <li><a href="{{ route('landing.profil') }}" class="hover:text-primary-500 transition">Profil</a></li>
                        ...
                        <li><a href="{{ route('landing.kontak') }}" class="hover:text-primary-500 transition">Kontak</a></li>
                    </ul>
                </div>
                <div>
